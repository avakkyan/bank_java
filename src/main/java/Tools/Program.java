...
import Entites.Bank.CentralBank;
...
public class Program {
    ...
    public static void main(String[] args) throws BankException {
        ...
        var tinkoff = centralBank.addBank("Tinkoff", 1, 1, 4, 6000, 20000, 20000);
        centralBank.addClientBank(oldClient, tinkoff);
        Account bankAccount = centralBank.createCreditAccountForClient(tinkoff, oldClient, 10000);
